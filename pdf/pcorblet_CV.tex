...
\begin{rSection}{Working Papers}
  ...
  \begin{enumerate}
    ...
    \item {\bf Higher-Educated Workers’ Flattening Returns to Experience} \textit{R\&R Journal of Human Capital}
    ...
    \item {\bf Modeling Monospony on the Labor Market with Separable Matching Models}, with Arnaud Dupuy, \textit{R\&R Journal of Applied Econometrics}
    \item {\bf Repeated Matching Games: an Empirical Framework}, with Jeremy Fox and Alfred Galichon, \textit{R\&R Econometrica}
  \end{enumerate}
...
\begin{itemize}
  \item {\bf NonLinearProg}, a Julia wrapper to call non linear optimization routines, developed with Simon Weber
  \item {\bf SeparableMatchingEstim}, a Julia package to estimate separable matching models, developed with Arnaud Dupuy
\end{itemize}
...
\begin{itemize}
  \item 2026: Sciences Po workshop on Family Economics, MATCH UP Paris (poster), IAAE 2026.
...
{\em Organizer} - Female Voices in Empirical Economics \hfill {2026}
